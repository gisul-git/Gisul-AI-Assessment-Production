...
import { restartKernel, isConnected } from './agentClient'

const NotebookCell = dynamic(() => import('./AIMLNotebookCell'), {
  ssr: false,
        ...
        <div className="max-w-4xl mx-auto space-y-2">
          {cells.map((cell, index) => (
            <NotebookCell
              ...
              onDelete={cells.length > 1 && !readOnly ? () => deleteCell(cell.id) : () => {}}
